...
function Quiz(){
    ...
    const validateAnswer = (selectedOption) => {
        let correct_answer = data[currentQuestionIndex]['correct_answer'];
        ...
        if(selectedOption==correct_answer){
            ...
            // pontuação 
            setPontuacao(score*10)
            console.log('pontuação; ' , pontuacao)
        }else {
            setPontuacao(setPontuacao/0.2)
        }
        // Show Next Button
    ...
    const renderOptions = () => {
        return (
            <View>
                {
                    data[currentQuestionIndex]?.incorrect_answers.map(option => (
                        <TouchableOpacity 
    ...
    return (
       <SafeAreaView style={{
           ...
           <View style={{
               ...
               >
                   <View style={{
                       ...
                       <View style={{
                           ...
                           <Text style={{fontSize: 30, fontWeight: 'bold'}}>{ score> (data.length/2) ? 'Congratulations!' : 'Report!' }</Text>
               ...
               {/* Background Image */}
               <Image
                source={require('../../assets/images/UIWindows.png')}
                style={{
                    width: SIZES.width,
                    height: 170,
                    zIndex: -1,
